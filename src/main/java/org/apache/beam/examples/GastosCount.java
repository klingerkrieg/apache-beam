...
public class GastosCount {

  
	static class ExtractNamesFn extends DoFn<String, String> {
	    
		private final Counter emptyLines = Metrics.counter(ExtractNamesFn.class, "emptyLines");
  ...
  public static class CountNames extends PTransform<PCollection<String>,
